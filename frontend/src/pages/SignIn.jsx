        ...
        <div className="glass-panel p-6 sm:p-8">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button type="button" onClick={() => handleOAuth('google')} className="flex justify-center items-center py-2.5 border border-white/10 rounded-lg hover:bg-white/5 transition-colors">
                <img src="/images/google.svg" alt="Google" className="h-5 w-5" />
              </button>
              <button type="button" onClick={() => handleOAuth('linkedin')} className="flex justify-center items-center py-2.5 border border-white/10 rounded-lg hover:bg-white/5 transition-colors">
                <img src="/images/linkedin.png" alt="LinkedIn" className="h-5 w-5" />
              </button>
              <button type="button" onClick={() => handleOAuth('github')} className="flex justify-center items-center py-2.5 border border-white/10 rounded-lg hover:bg-white/5 transition-colors text-white">
